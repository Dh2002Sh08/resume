...
<body class = "back_ground">
    ...
    <div class = "resume_back" style = " background-image:url('good.jpeg'); background-repeat:no-repeat;
    background-size: cover;  background-position:center ;">
        ...
        <div class = "skill_area">
            <!-- qualification -->
           <h2  style = "font-size:16px; font-weight:bold;  font-family: Comic Sans MS, Comic Sans, cursive;" >Qualification</h2>
        ...
        <div class = "experience">
            <!-- achievements -->
           <h2  style = "font-size:16px; font-weight:bold;  font-family: Comic Sans MS, Comic Sans, cursive;" >Achievements</h2>
