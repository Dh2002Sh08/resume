...
<body class="back_ground">
    <div class="previous">
        <a href="resume4.php"><i class="fas fa-arrow-left fa-lg" style="color: #8424f9;"></i></a>
    </div>
    <!-- <div class = "forward">
         <a href = "resume5.php"><i class="fas fa-arrow-right fa-lg" style="color: #8424f9;"></i></a>
    </div> -->
    <div class="resume_back5">
        <div class="back">
            <?php
        ...
        <div class="name" style='font-family: Comic Sans MS, Comic Sans, cursive;'>
            <!-- name -->
            <h1><?php 
            //  $resu = $obj->select($id);
            //  $name = $_SESSION['name'];
    ...
    <div class="download">
        <a href="pdf_resume5.php" class="btn btn-simple" target="_blank" download>Download</a>
