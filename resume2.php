...
<body class="back_ground">
    <div class="previous">
        <a href="resume1.php"><i class="fas fa-arrow-left fa-lg" style="color: #8424f9;"></i></a>
    </div>
    <div class="forward">
        <a href="resume3.php"><i class="fas fa-arrow-right fa-lg" style="color: #8424f9;"></i></a>
    </div>
    <div class="resume_back2">
        <div class="back">
            <?php
        ...
        <div class="name" style="font-family: cursive;">
            <!-- name -->
            <h1><?php 
            //  $resu = $obj->select($id);
            //  $name = $_SESSION['name'];
    ...
    <div class="download">
        <a href="pdf_resume2.php" target="_blank" class="btn btn-simple" download>Download</a>
