...
<head>
    ...
    <link rel="icon" href="ato.png" type="images/x-icon">
    <title>RESUME</title>
    <style>
    p {
        font-style: italic;
...
<body class="back_ground">
    <div class="previous">
        <a href="first_resume.php"><i class="fas fa-arrow-left fa-lg" style="color: #8424f9;"></i></a>
    </div>
    <div class="forward">
        <a href="resume2.php"><i class="fas fa-arrow-right fa-lg" style="color: #8424f9;"></i></a>
    </div>
    <div class="resume_back1">
        <div class="back">
            <?php
        ...
        <div class="name" style="font-style:italic;">
            <!-- name -->
            <h1><?php 
            //  $resu = $obj->select($id);
            //  $name = $_SESSION['name'];
    ...
    <div class="download">
        <a href="pdf_resume1.php" target="_blank" class="btn btn-simple" download>Download</a>
